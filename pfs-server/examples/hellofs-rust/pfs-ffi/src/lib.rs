//! # PFS Plugin SDK
//!
//! A Rust SDK for building filesystem plugins for PFS Server with clean separation
...
///
/// This macro generates all the necessary FFI functions to interface with PFS Server.
///
/// # Example
///
/// ```rust,ignore

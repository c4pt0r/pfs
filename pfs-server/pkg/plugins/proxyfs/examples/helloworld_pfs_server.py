#!/usr/bin/env python3
"""
HelloWorld PFS Server - A simple Python implementation of PFS HTTP API
...
Usage:
    python3 helloworld_pfs_server.py [--port PORT]

Example:
    # Start the server
    python3 helloworld_pfs_server.py --port 9090
"""
...
class PFSRequestHandler(BaseHTTPRequestHandler):
    """HTTP request handler implementing PFS API"""
...
def main():
    parser = argparse.ArgumentParser(
        description='HelloWorld PFS Server - A simple read-only file system'
    )
    parser.add_argument(
        '--port',
        type=int,
...
║          A simple read-only mock pfs http service             ║
╚═══════════════════════════════════════════════════════════════╝

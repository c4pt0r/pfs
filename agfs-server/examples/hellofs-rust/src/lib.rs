//! HelloFS Rust Plugin using AGFS FFI
//!
//! This is a simple example demonstrating how to use the AGFS FFI library
...
A simple read-only filesystem plugin written in Rust using the AGFS Plugin SDK.

## Features
- Single file: /hello containing 'Hello from Rust dynamic library!'
- Demonstrates idiomatic Rust plugin interface for agfs-server
- Built with the AGFS Plugin SDK for minimal boilerplate
"#
    }
